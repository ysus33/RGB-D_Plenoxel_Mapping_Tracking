...
group.add_argument('--train_dir', '-t', type=str, default='ckpt', help='checkpoint and logging directory')
...
group.add_argument('--n_iters', type=int, default=1 * 12800, help='total number of iters to optimize for')
